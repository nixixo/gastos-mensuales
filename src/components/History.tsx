        ...
        return (
          <div key={`${m.year}-${m.month}`}>
            <button
              ...
              className="w-full flex items-center justify-between py-4 px-1 hover:bg-white/5 transition-colors rounded-lg"
            >
            ...
            {/* Expanded content */}
            {isExpanded && expanded && (
              <div className="pl-2 pb-4 space-y-2 border-l border-white/10 ml-2">
